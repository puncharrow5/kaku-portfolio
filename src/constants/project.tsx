...
export const projects: Project[] = [
  ...
  // },
  {
    ...
    achievements: [
      ...
      "가상화폐 시세 조회 기능을 스케줄링과 캐싱을 활용하여 API 호출 수 절감 및 응답속도 향상",
      "다양한 모바일 기기에서의 입력 UX를 개선하기 위해 KeyboardAvoidingView 대신 커스텀 컴포넌트를 구현, 자연스러운 애니메이션과 대응력 향상에 기여",
      "Tailwind CSS 도입 제안 및 적용을 주도하여 생상성 향상 및 UI 일관성 유지에 기여",
      "스켈레톤 이미지를 도입하여 로딩 중 사용자 경험 개선",
      "전반적인 리팩토링을 통해 코드 및 컴포넌트 구조의 일관성 및 유지보수성 향상",
      "전반적인 앱 성능 및 속도 개선",
      "방배사 앱 및 어드민 개발 완료, App Store · Play Store 등록 완료",
    ],
